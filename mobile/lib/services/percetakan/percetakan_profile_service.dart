...
import 'package:publishify/models/percetakan/profile_api_models.dart';
import 'package:publishify/models/percetakan/update_profile_models.dart';
...
class ProfileService {
  ...
  static Future<void> _updateCache(UpdatedUserData data) async {
    ...
    try {
      ...
      logger.e('Error updating user_data cache: $e');
    }
  }
}
