      ...
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-6 sm:py-8 space-y-6 sm:space-y-8">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  <div className={`w-10 h-10 sm:w-12 sm:h-12 ${card.bgColor} rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform`}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-slate-700">Percetakan</span>
                </div>
              ...
              <div className="space-y-3">
                {aktivitasTerbaru.map((aktivitas) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-slate-900 text-sm truncate group-hover:text-teal-600 transition-colors">{aktivitas.judul}</p>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl border border-slate-200 p-4 sm:p-6 shadow-sm">
            ...
            <div className="mt-6 pt-4 border-t border-slate-100">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-bold text-slate-900">{loading ? "..." : statistik.totalNaskah}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-teal-600 to-cyan-600 rounded-lg sm:rounded-xl p-4 sm:p-6 text-white shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h3 className="text-base sm:text-lg font-semibold">Butuh Bantuan?</h3>
